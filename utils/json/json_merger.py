    ...
    def merge_files(self):
        for file in self.files:
            ...
            for key, value in data.items():
                if key not in self.merged_file_contents:
                    self.merged_file_contents[key] = value
                else:
                    self.merged_file_contents[key].update(value)
...
if __name__ == '__main__':
    # Create the path to the directory containing the json files.
